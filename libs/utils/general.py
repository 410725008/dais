...
from libs.utils.google_utils import gsutil_getsize
from libs.utils.metrics import fitness
from libs.utils.torch_utils import init_torch_seeds
...
def check_requirements(requirements='detect_requirements.txt', exclude=()):
...
def strip_optimizer(f='best.pt', s=''):  # from libs.utils.general import *; strip_optimizer()
